...
public class UpdateSupplierService {
    ...
    public Supplier updateSupplier(Long userID, Supplier supplier)
        ...
        Optional<Supplier> oldSupplierOptional = this.supplierRepository
        ...
        if ((oldSupplierOptional.isPresent()) && (oldSupplierOptional.get().getUserID().equals(userID))) {
            ...
            if (phoneNumber != null) {
                Optional<Supplier> optionalPhoneSupplier = this.supplierRepository
                        .findSupplierByUserIDAndPhoneNumber(userID, phoneNumber);
                if ((optionalPhoneSupplier.isPresent()) &&
                    ...
                    throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                            "This phone number has been used for another supplier: "
                                    + optionalPhoneSupplier.get().getName());
                }
            }
