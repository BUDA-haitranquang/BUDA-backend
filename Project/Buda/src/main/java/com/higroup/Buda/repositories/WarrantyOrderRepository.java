...
public interface WarrantyOrderRepository extends JpaRepository<WarrantyOrder, Long> {
    Optional<WarrantyOrder> findWarrantyOrderByWarrantyOrderID(@Param("warrantyOrderID") Long warrantyOrderID);
    List<WarrantyOrder> findAllByUserID(@Param("userID") Long userID);
