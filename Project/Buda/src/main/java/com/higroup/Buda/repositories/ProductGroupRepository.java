...
public interface ProductGroupRepository extends JpaRepository<ProductGroup, Long>{
    ...
    Optional<ProductGroup> findProductGroupByProductGroupID(@Param("productGroupID") Long productGroupID);
    List<ProductGroup> findAllByUserID(@Param("userID") Long userID);
