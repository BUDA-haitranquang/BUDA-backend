...
public class CRUDProductService {
    ...
    @Autowired
    public CRUDProductService(ProductRepository productRepository, ProductGroupRepository productGroupRepository, UserRepository userRepository, ProductLeftLogRepository productLeftLogRepository)
    {
