...
CREATE TABLE `supplier` (
  ...
  CONSTRAINT `PictureID_fk` FOREIGN KEY (`PictureID`) REFERENCES `picture` (`PictureID`),
  CONSTRAINT `UID_fk` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`) ON DELETE SET NULL
